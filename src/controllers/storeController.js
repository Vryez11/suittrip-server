...
export const getStoreSettings = async (req, res) => {
  try {
    ...
    const operationSettings = hours && hours.length > 0 ? {
      operatingDays: {
        '월': hours[0].monday_operating,
        '화': hours[0].tuesday_operating,
        '수': hours[0].wednesday_operating,
        '목': hours[0].thursday_operating,
        '금': hours[0].friday_operating,
        '토': hours[0].saturday_operating,
        '일': hours[0].sunday_operating,
      },
      openTime: hours[0].monday_open || '9:0',
      closeTime: hours[0].monday_close || '22:0',
      dailyHours: {
        '월': { openTime: hours[0].monday_open || '9:0', closeTime: hours[0].monday_close || '22:0', isOperating: hours[0].monday_operating },
        '화': { openTime: hours[0].tuesday_open || '9:0', closeTime: hours[0].tuesday_close || '22:0', isOperating: hours[0].tuesday_operating },
        '수': { openTime: hours[0].wednesday_open || '9:0', closeTime: hours[0].wednesday_close || '22:0', isOperating: hours[0].wednesday_operating },
        '목': { openTime: hours[0].thursday_open || '9:0', closeTime: hours[0].thursday_close || '22:0', isOperating: hours[0].thursday_operating },
        '금': { openTime: hours[0].friday_open || '9:0', closeTime: hours[0].friday_close || '22:0', isOperating: hours[0].friday_operating },
        '토': { openTime: hours[0].saturday_open || '9:0', closeTime: hours[0].saturday_close || '22:0', isOperating: hours[0].saturday_operating },
        '일': { openTime: hours[0].sunday_open || '9:0', closeTime: hours[0].sunday_close || '22:0', isOperating: hours[0].sunday_operating },
      },
