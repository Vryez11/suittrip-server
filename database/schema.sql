...
CREATE TABLE IF NOT EXISTS stores (
  ...
  phone_number VARCHAR(20) COMMENT '사장님 개인 연락처 (알림/정산 문의용)',
  store_phone_number VARCHAR(20) COMMENT '매장 대표 연락처 (고객 노출용)',
  wants_sms_notification BOOLEAN NOT NULL DEFAULT FALSE COMMENT '사장님 휴대폰 SMS 알림 수신 동의 여부',
